...
public class OneEvenementListCardController {
    ...
    public void setEvenementData(Evenement evenement) {
        ...
        try {
            // Use a default image from the available images in the resources
            String imagePath = "/images/add.png"; // Default image
            ...
            System.out.println("Error setting event data: " + e.getMessage());
            e.printStackTrace();
        }
    }
}
